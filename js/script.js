...
// Музыка 
// на 57 строчке в html index нужно убрать checked <input class="mute__checkbox" type="checkbox" id="mute" checked> 

// try {const mute = document.querySelector('.mute__checkbox');
